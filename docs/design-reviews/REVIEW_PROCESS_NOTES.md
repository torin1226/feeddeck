...
6. **Accessibility Deep Dive** (NEXT) -- WCAG AA compliance, screen reader walkthrough, keyboard-only navigation
7. **Micro-interaction Audit** -- hover states, click feedback, transition timing, gesture responses
8. **Content Strategy** -- how content is categorized, surfaced, and rotated; freshness signals
